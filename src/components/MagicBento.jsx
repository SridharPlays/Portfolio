  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2 font-[Lexend]">
            ...
            if (enableStars) {
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-[--text-secondary]">
                    <h3
                ...
                ref={(el) => {
                  ...
                  const handleClick = (e) => {
                    ...
                    ripple.style.cssText = `
                      ...
                      height: ${maxDistance * 2}px;
                      border-radius: 50%;
                      /* Change: Switched to a subtle, low-opacity black for a grey effect */
