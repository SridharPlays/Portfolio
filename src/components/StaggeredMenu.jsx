    ...
    <div
      ...
      <div
        ...
        <header
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 text-[#e9e9ef] font-medium leading-none overflow-visible pointer-events-auto"
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 w-full h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]"
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  <li
                    ...
                    key={it.label + idx}>
                    <a
                      className="sm-panel-item relative text-black font-semibold text-[4rem] leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]"
                      href={it.link}
...
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.3rem; background: transparent; border: none; color: #e9e9ef; font-weight: 500; line-height: 1; overflow: visible; }
...
.sm-scope .sm-panel-item { position: relative; color: #000; font-weight: 600; font-size: 4rem; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
